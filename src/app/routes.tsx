...
export const appRoutes: AppRouteDefinition[] = [
  ...
  defineRoute({ path: "/pilotage", importPage: () => import("@/pages/PilotageMenu") }),
  ...
  defineRoute({ path: "/weather", importPage: () => import("@/pages/WeatherMenu") }),
  defineRoute({ path: "/weather/systems", importPage: () => import("@/pages/WeatherSystemsTheory") }),
  defineRoute({ path: "/weather/beaufort", importPage: () => import("@/pages/BeaufortTheory") }),
  defineRoute({ path: "/weather/forecasts", importPage: () => import("@/pages/WeatherForecastsTheory") }),
  defineRoute({ path: "/weather/fog", importPage: () => import("@/pages/FogTheory") }),
  defineRoute({ path: "/passage-planning", importPage: () => import("@/pages/PassagePlanningMenu") }),
  defineRoute({ path: "/passage-planning/prepare", importPage: () => import("@/pages/PrepareTheory") }),
  defineRoute({ path: "/passage-planning/calculator", importPage: () => import("@/pages/PassageCalculator") }),
  defineRoute({ path: "/passage-planning/builder", importPage: () => import("@/pages/PassagePlan") }),
  defineRoute({ path: "/passage-planning/checklist", importPage: () => import("@/pages/PreDepartureChecklist") }),
  ...
  defineRoute({ path: "/safety/flares", importPage: () => import("@/pages/FlaresTheory") }),
  defineRoute({ path: "/safety/personal", importPage: () => import("@/pages/PersonalSafetyTheory") }),
  defineRoute({ path: "/safety/gas", importPage: () => import("@/pages/GasSafetyTheory") }),
  defineRoute({ path: "/quiz/:topicId", importPage: () => import("@/pages/Quiz") }),
  defineRoute({ path: "/exam", importPage: () => import("@/pages/Exam") }),
  defineRoute({ path: "/exam/history", importPage: () => import("@/pages/ExamHistory") }),
  defineRoute({ path: "/review", importPage: () => import("@/pages/Review") }),
