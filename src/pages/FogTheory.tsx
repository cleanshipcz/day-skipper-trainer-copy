...
export const fogTheorySections: readonly TheorySection[] = [
  ...
  },
  {
    ...
    body: <ul className="list-disc pl-5"><li>UK Met Office: <a className="underline" href="https://weather.metoffice.gov.uk/guides/coast-and-sea/glossary">Coast and sea glossary</a> (visibility terminology).</li><li>UK Met Office: <a className="underline" href="https://www.metoffice.gov.uk/weather/learn-about/weather/types-of-weather/fog/types-of-fog">Types of fog</a> and <a className="underline" href="https://www.metoffice.gov.uk/weather/learn-about/weather/types-of-weather/fog/difference-mist-and-fog">fog, mist and haze</a>.</li><li>UK Met Office: <a className="underline" href="https://www.metoffice.gov.uk/weather/learn-about/weather/types-of-weather/humidity">Humidity and dew point</a>.</li><li>U.S. Coast Guard: <a className="underline" href="https://www.navcen.uscg.gov/sites/default/files/pdf/navRules/Handbook/NavRules_Handbook_Corrected_08_08_2024.pdf">Navigation Rules and Regulations Handbook, corrected 8 August 2024</a>, COLREG Rules 3, 19 and 35.</li></ul>,
  },
];
