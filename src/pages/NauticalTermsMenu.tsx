...
const NauticalTermsMenu = () => {
  ...
  return (
    <ModuleMenuPage
      ...
      subtitle="Learn the language of sailing"
      onBack={() => navigate("/")}
      modules={subModules}
      onNavigate={navigate}
      introCard={
          ...
          <CardContent>
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li className="flex items-start gap-2">
                <span className="text-primary font-bold">•</span>
                <span>
                  The <strong>bow</strong> is the front, the <strong>stern</strong> is the back. "Bow" rhymes with
                  "go" - where you're heading!
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-primary font-bold">•</span>
                <span>
                  <strong>Sheets</strong> control sail angle, <strong>halyards</strong> raise and lower sails.
                  "Halyard" = "haul yard" (the sail up).
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-primary font-bold">•</span>
