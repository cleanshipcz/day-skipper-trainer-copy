...
describe("FogTheory completion evidence", () => {
  ...
  it("uses revisioned fog evidence and explains the locked requirement", () => {
    render(<FogTheory />);
    expect(mocks.useGate).toHaveBeenCalledWith({ topicId: "weather-fog", catalogueRevision: FOG_SCENARIO_GATE.revision, requiredSectionIds: [...FOG_SCENARIO_GATE.scenarioIds], pointsOnComplete: 10 });
