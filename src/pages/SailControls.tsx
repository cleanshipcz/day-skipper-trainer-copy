...
const sailControls: SailControl[] = [
  ...
  },
  {
    ...
    location: "Aft end of boom → mast or masthead fitting; may be fixed or adjustable",
  ...
  },
  {
    ...
    effect: "Windward can bring the boom toward centre while retaining mainsheet-set leech tension. Leeward commonly opens the leech, reduces heel and depowers.",
