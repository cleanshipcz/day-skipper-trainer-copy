...
export const PilotagePlanBuilder = ({ onComplete }: Props) => {
  ...
  return <div className="space-y-6">
    ...
    <Card><CardHeader><CardTitle>3. Validate, review and brief</CardTitle></CardHeader><CardContent className="space-y-3">
