  ...
  <div className="space-y-6" data-testid="anchor-geometry-visuals">
    <figure className="space-y-3">
      ...
      <svg className="block h-auto w-full min-w-[42rem] rounded-lg border bg-background text-foreground" viewBox="0 0 700 300" role="img" aria-labelledby="anchor-side-title" aria-describedby="anchor-side-desc">
        ...
        <path d="M90 220L501 136" className={`${line} fill-none`} strokeWidth="4" /><path d="M80 211l10 9-14 8m14-8 13 8m-13-8v-21" className={`${line} fill-none`} strokeWidth="4" /><text x="190" y="193" className={label}>Rode length 35 m</text>
        ...
        <path d="M90 266h411M90 259v14m411-14v14" className={`${line} fill-none`} strokeWidth="2" /><text x="295" y="288" textAnchor="middle" className={label}>Horizontal reach ≈ 34.3 m</text>
    ...
    <figure className="space-y-3">
      ...
      <svg className="block h-auto w-full min-w-[42rem] rounded-lg border bg-background text-foreground" viewBox="0 0 700 420" role="img" aria-labelledby="anchor-plan-title" aria-describedby="anchor-plan-desc">
        ...
        <rect width="700" height="420" className="fill-background" /><circle cx="320" cy="220" r="190" fill="url(#clearance-hatch)" className={line} strokeWidth="2" strokeDasharray="8 5" /><circle cx="320" cy="220" r="155" className={`${line} fill-background`} strokeWidth="3" />
