...
export const COLREG_SCENARIOS: readonly ColregScenario[] = [
  { id: "sailing", title: "Sailing vessels on the same tack", rule: "Rules 5, 7, 8 and 12", conditions: "Daylight, clear visibility, open water", geometry: "Target 045° relative, 0.7 NM, steady bearing; both steering 000°", own: "Sailing vessel, wind from port, leeward", target: "Sailing vessel, wind from port, windward", observation: "Repeated bearings remain 045° while range closes.", risk: "Risk exists: steady bearing and decreasing range.", answers: ["Sailing encounter, same side of wind", "Target is windward and must keep out of the way; we continue the assessment", "Maintain course and speed initially, ready to act if required", "Recheck bearing and range until finally past and clear"], distractors: [["Head-on power-driven encounter", "Insufficient information: stop observing"], ["We must give way because target is to starboard", "Neither vessel has responsibilities"], ["Make several small alterations", "Alter to port immediately"], ["Stop monitoring once target turns", "Assume passing distance is safe"]] },
