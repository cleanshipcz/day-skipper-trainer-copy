...
export const forecastAreas: readonly ForecastArea[] = [
  ...
  area("South Utsire", [522,282], "491,279 539,274 538,337 490,337", "Southern waters off western Norway", ["North Utsire", "Forties", "Fisher"]),
  ...
  area("Cromarty", [376,287], "347,272 451,266 450,311 400,311 365,303 329,311", "Waters north and northeast of Scotland", ["Hebrides", "Fair Isle", "Forties", "Malin", "Forth"]),
  area("Forties", [448,301], "451,266 491,279 490,337 450,337 450,311", "North Sea east of Scotland", ["Viking", "South Utsire", "Cromarty", "Fisher", "Forth", "Dogger"]),
  ...
  area("Irish Sea", [335,389], "313,354 359,349 375,405 359,437 321,431 302,393", "Waters between Ireland and Great Britain", ["Malin", "Lundy", "Fastnet"]),
  ...
  area("Fastnet", [278,447], "260,412 302,393 321,431 310,468 240,466", "Waters south of Ireland", ["Shannon", "Irish Sea", "Lundy", "Sole", "Plymouth"]),
  area("Lundy", [346,451], "321,431 359,437 407,452 398,482 347,483 310,468", "Bristol Channel and its approaches", ["Irish Sea", "Fastnet", "Plymouth"]),
  ...
  area("Plymouth", [311,504], "240,466 310,468 347,483 344,520 319,535 276,535 289,492", "Western English Channel and southwest approaches", ["Sole", "Fastnet", "Lundy", "Portland", "FitzRoy", "Biscay"]),
  area("Portland", [363,513], "347,483 398,482 400,518 375,537 344,520", "English Channel south of Dorset", ["Plymouth", "Wight"]),
