...
export const ukCarriageGuidance = "UK pleasure vessels 13.7 m and over are Class XII. For a Class XII vessel operating in Category C waters and seaward under the current MGN 599 exemption, MIN 542 Amendment 3 identifies three required elements: a maritime radio suitable for the area (DSC strongly recommended), 4 red hand flares plus 2 orange smoke flares, and another alerting device such as an EPIRB or PLB. Pleasure vessels under 13.7 m have no specific statutory flare-carriage requirement in this guidance, but COLREG distress-signal recognition still applies. Commercial/coded vessels, other operating areas and vessels not using that exemption have different requirements: verify the vessel's current regime rather than transferring the Class XII outfit.";
