...
export interface ChecklistItem {
  ...
  /** Whole-item omission is safe after a recorded, authority-based decision. */
...
export const preDepartureChecklist: readonly ChecklistItem[] = [
  ...
  {id:"emergency-readiness",phase:"Crew and vessel readiness",label:"Check accessible fire, MOB, flooding/bilge and first-aid equipment; brief immediate actions",why:"These readiness checks are universal and cannot be dismissed wholesale as not applicable. Cross-reference the dedicated safety lessons and actual vessel plan; inspect condition, location, safe access and crew ability."},
  {id:"conditional-survival",phase:"Crew and vessel readiness",label:"Check required liferaft, pyrotechnics, beacons and other abandon-vessel equipment",why:"Where carried or required, inspect accessibility, condition, registration and service status and brief deployment without unsafe test activation.",conditional:conditional("Carriage of a liferaft, pyrotechnics, beacon and some other survival equipment depends on vessel and voyage; record each actual requirement before choosing not applicable.","Flag/coastal-state rules, coding or certificate requirements, manufacturer instructions and a competent person determine applicability and serviceability."),notApplicableAllowed:true},
  {id:"provisions",phase:"Crew and vessel readiness",label:"Confirm sufficient potable water and food for every crew member, the planned passage and realistic contingency or delay",why:"Use the Victualling module for quantities, dietary/medical needs, reserves, contamination control and secure accessible stowage."},
  ...
  {id:"ventilation",phase:"Pre-start checks",label:"Ventilate as the installation requires and operate a fitted blower for the labelled/manual period where required",why:"Petrol/gasoline and other arrangements are installation-specific; ventilation does not replace inspection.",conditional:conditional("Required where fitted or specified for the actual machinery/fuel installation.","Vessel/engine manuals, labels and applicable equipment rules control the sequence and duration."),notApplicableAllowed:true},
  ...
  {id:"vhf-dsc",phase:"Immediate running checks",label:"Confirm lawful VHF/DSC readiness, power, position source, MMSI/display and listening arrangements",why:"For normal installation, testing and operation, comply with station licensing and operator-qualification requirements and use an appropriate non-distress check; never send a DSC distress alert or false distress message merely to test. In a genuine emergency, crew should use available distress communications as applicable emergency provisions permit—raise the distress promptly rather than withholding it through licensing doubt.",conditional:conditional("Fixed/handheld VHF, DSC, AIS and satellite equipment vary by vessel, area and voyage.","Radio licence, operator qualification, equipment approval, manufacturer instructions and current local radio procedures control normal installation, testing and operation; applicable emergency provisions govern genuine distress use.")},
