...
export const topicRegistry: readonly TopicEntry[] = [
  ...
  { id: "navigation", label: "Navigation Fundamentals", parentId: null, route: "/navigation", quizRoute: null, submoduleIds: ["charts-theory", "compass-theory", "tides", "position-theory"], syllabusArea: 6 },
  ...
  { id: "tides", label: "Tides", parentId: "navigation", route: "/navigation/tides", quizRoute: null, submoduleIds: ["tides-theory", "tides-heights-theory", "tides-heights-calc", "tides-streams-theory", "tides-vector-tool"], syllabusArea: 8 },
  { id: "tides-theory", label: "Understanding Tides", parentId: "tides", route: "/navigation/tides/theory", quizRoute: null, submoduleIds: [], syllabusArea: 8 },
  { id: "tides-heights-theory", label: "Calculating Tidal Heights", parentId: "tides", route: "/navigation/tides/heights-theory", quizRoute: null, submoduleIds: [], syllabusArea: 8 },
  { id: "tides-heights-calc", label: "Tidal Height Calculator", parentId: "tides", route: "/navigation/tides/heights-calc", quizRoute: null, submoduleIds: [], syllabusArea: 8 },
  { id: "tides-streams-theory", label: "Course to Steer Theory", parentId: "tides", route: "/navigation/tides/streams-theory", quizRoute: null, submoduleIds: [], syllabusArea: 10 },
  { id: "tides-vector-tool", label: "Vector Solution Tool", parentId: "tides", route: "/navigation/tides/vector-tool", quizRoute: null, submoduleIds: [], syllabusArea: 10 },
...
export const TOPIC_IDS = {
  ...
  TIDES: "tides",
  TIDES_THEORY: "tides-theory",
  TIDES_HEIGHTS_THEORY: "tides-heights-theory",
  TIDES_HEIGHTS_CALCULATOR: "tides-heights-calc",
  TIDES_STREAMS_THEORY: "tides-streams-theory",
  TIDES_VECTOR_TOOL: "tides-vector-tool",
  POSITION_THEORY: "position-theory",
  VECTOR_TRIANGLE: "tides-vector-tool",
  PILOTAGE: "pilotage",
