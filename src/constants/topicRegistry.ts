...
export const topicRegistry: readonly TopicEntry[] = [
  ...
  // ── Syllabus Area 4: Safety ──────────────────────────────────────────
  {
    ...
    route: "/safety",
    quizRoute: null,
    submoduleIds: ["safety-mob", "safety-fire", "safety-life-raft", "safety-flares"],
    syllabusArea: 4,
  },
  {
    id: "safety-mob",
  ...
  {
    id: "safety-flares",
    label: "Flares & Pyrotechnics",
    parentId: "safety",
    route: "/safety/flares",
    quizRoute: "/quiz/safety-flares-quiz",
    submoduleIds: ["safety-flares-drill"],
    syllabusArea: 4,
  },
  {
    id: "safety-flares-drill",
    label: "Flare Identification Drill",
    parentId: "safety-flares",
    route: "/safety/flares",
    quizRoute: null,
    submoduleIds: [],
    syllabusArea: 4,
