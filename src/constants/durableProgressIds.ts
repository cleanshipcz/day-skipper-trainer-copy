...
export const DURABLE_PROGRESS_IDS = [
  ...
  "navigation", "charts-theory", "compass-theory", "tides", "tides-theory", "tides-heights-theory",
  "tides-heights-calc", "tides-streams-theory", "tides-vector-tool", "position-theory",
