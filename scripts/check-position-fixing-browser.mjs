...
try {
  ...
  console.log("Position Fixing browser checks passed at 375/768/1280 and 100%/200% text after recording and precisely plotting one sight: revealed observation/reciprocal controls and evidence/LOP history reflow without overflow, chart geometry remains 8:5, visible controls remain at least 44px, and desktop enlargement is material.");
} finally {
