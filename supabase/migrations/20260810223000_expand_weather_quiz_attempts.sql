-- Keep newly issued quiz attempts aligned with the expanded Meteorology quiz.
-- Existing attempts retain the expected_total recorded when they were issued.
...
begin
  ...
  expected := case p_topic_id
    ...
    when 'weather' then 21 when 'passage-planning' then 20 else null end;
