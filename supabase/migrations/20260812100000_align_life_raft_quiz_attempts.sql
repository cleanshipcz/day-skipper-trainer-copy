-- Keep newly issued attempts aligned with the 12-question Life Raft applied check.
-- Existing issued attempts retain their recorded expected_total and remain valid.
